 ...
 *  Year        :  2015
 */
planti.controllers.controller('AdminController', function ($scope, $http) {
  $scope.loading = true;
  
  $scope.goModels = function() {
    $scope.tab = 'models';
    $scope.view = 'views/models-list.html';
  };
 ...
 *  Year        :  2015
 */
planti.controllers.controller('SettingsController', function ($scope, $http, $state) {
  $scope.$state = $state;
});
